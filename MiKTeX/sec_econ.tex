...
Общая сумма затрат на разработку программного модуля составит\linebreak9786,68 рублей.
...
\begin{itemize}
 ...
 \item Пессимистический уровень чистой месячной прибыли составляет\linebreak7948,98 рублей
